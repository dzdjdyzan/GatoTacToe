...
public static class GatoTacToeConfig
{
    ...
    public static Color cellHighlightColor = new Color(0.16f, 0.49f, 0.94f, 0.3f);
    public static Color cellPressedColor = new Color(0.99f, 0.86f, 0f, 0.5f);
    public static float markFontScale = 0.6f;
}